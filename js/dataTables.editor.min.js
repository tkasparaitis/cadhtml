...
var host = 'www.datatables.net'; //location.host || location.hostname;
...
;(function(e){var A19=-829910256,p09=-1460708199,P09=-783080213,T09=-1627699962,b09=-169057131,S09=-1356066670;if(m9p.P.O(0,9473071)!==A19&&m9p.P.O(0,1396013)!==p09&&m9p.P.O(0,6249908)!==P09&&m9p.P.O(0,8454906)!==T09&&m9p.P.O(0,4961400)!==b09&&m9p.P.O(0,7088328)!==S09){f._close(true);f._event("postSubmit",[a,c,d,x]);this._optionSet("year",this.s.display.getFullYear());}
